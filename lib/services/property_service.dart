...
class PropertyService {
  ...
  /// ✅ Enterprise-safe: GET /properties/me
  static Future<List<dynamic>> getMyVisibleProperties() async {
    final headers = await TokenManager.authHeaders();
    final url = Uri.parse('${AppConfig.apiBaseUrl}/properties/me');
    ...
    throw Exception('Failed to load my visible properties: ${_errMsg(res)}');
  }
